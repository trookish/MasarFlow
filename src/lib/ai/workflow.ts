...
export const WORKFLOW_STEPS: WorkflowStepDef[] = [
  ...
  { key: "requirements", title: "Requirements", role: "architect", instruction: "Write the functional and non-functional requirements as a concise, numbered list." },
  ...
  { key: "breakdown", title: "Task breakdown", role: "programmer", instruction: "Break the work into a sequenced list of implementation tasks with rough effort." },
  ...
  { key: "docs", title: "Documentation", role: "documenter", instruction: "Write the user- and developer-facing documentation for the feature in Markdown." },
  { key: "rollout", title: "Rollout & next steps", role: "optimizer", instruction: "Define the rollout plan, what to measure, and the highest-value next steps." },
];
...
export function buildStepPrompt(
  ...
  parts.push(`# Your task: ${step.title}\n${step.instruction}`);
  return parts.join("\n\n");
}
